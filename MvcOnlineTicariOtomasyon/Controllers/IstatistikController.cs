...
namespace MvcOnlineTicariOtomasyon.Controllers
{
    public class IstatistikController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            var deger15 = c.SatisHarekets.Count(x => x.SatisHareketTarih == bugun).ToString();
            ViewBag.d15 = deger15;
            var deger16 = c.SatisHarekets.Where(x => x.SatisHareketTarih == bugun).Sum(x =>(decimal?)x.SatisHareketToplamTutar);
            ViewBag.d16 = deger16;
            return View();
        }
